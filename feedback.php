...
<div class="col-md-10">
<a href="mailto:snaragund@gmail.com" style="color:#000000">snaragund6@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		 <div class="col-md-5">
		  <h4 style="font-family:'typo' ">Welcome to Online Exam</h4><br></div>
		<div class="col-md-12">
		<h4 style="font-family:'typo' ">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;This application is used to conduct online examination. The students can sit at individual terminals and login to write the exam in the given duration. This application will perform correction, display the result immediately and also store it in database. It also provides the administrator with a facility to add new exams.This application takes care of authentication of the administrator as well as the student.</h4>
		</div></div>
		</p>
      </div>
